...
<div class="paypal_mx-module-wrapper ">
	<div class="paypal_mx-module-header">
		...
		<span class="paypal_mx-module-intro">{l s='PayPal is the #1 solution to start accepting payments on the web today' mod='paypalmxcustom'}.<br />
		<span class="paypal_mx-module-singup-text">{l s='If you don\'t have a PayPal account' mod='paypalmxcustom'}.</span>
		<a class="paypal_mx-module-create-btn" rel="external" href="https://www.paypal.com/mx/webapps/mpp/referral/paypal-business-account2?partner_id=XYAYGKRUJMJTG" target="_blank"><span>{l s='Sign up for a PayPal account here' mod='paypalmxcustom'}</span></a></span>
	</div>
	<div class="paypal_mx-module-wrap">
		<div class="col-md-6">
			<h3>{l s='Credit and Debit Cards' mod='paypalmxcustom'}</h3>
			<p>{l s='With PayPal you can accept payments with all major credit and debit cards in 25 currencies from 190 countries.' mod='paypalmxcustom'}</p>
			
		</div>
		<div class="col-md-6">
			<h3>{l s='Monthly Payments Feature' mod='paypalmxcustom'}</h3>
			<p>{l s='Offer to your clients the possibility to make monthly payments using the following credit cards: Bancomer, Banamex, HSBC, Santander y Banorte.' mod='paypalmxcustom'}</p>
	...
	<form action="{$paypal_mx_form_link|escape:'htmlall':'UTF-8'}" method="post" class="form-horizontal">
		...
		<fieldset>
			<legend>
					...
					<span>{l s='PayPal PayPal Express Checkout API Settings' mod='paypalmxcustom'}</span>
			</legend>

			<div class="form-group">
				<label for="paypal_mx_sandbox_on" class="col-sm-3 control-label">
					{l s='Mode' mod='paypalmxcustom'}
				</label>
				<div class="col-sm-4">
					<input type="radio" name="paypal_mx_sandbox" id="paypal_mx_sandbox_on" value="0"{if $paypal_mx_configuration.PAYPAL_MX_SANDBOX == 0} checked="checked"{/if} /> <label for="paypal_mx_sandbox_on" class="resetLabel">{l s='Live' mod='paypalmxcustom'}</label>
					<input type="radio" name="paypal_mx_sandbox" id="paypal_mx_sandbox_off" value="1"{if $paypal_mx_configuration.PAYPAL_MX_SANDBOX == 1} checked="checked"{/if} /> <label for="paypal_mx_sandbox_off" class="resetLabel">{l s='Test (Sandbox)' mod='paypalmxcustom'}</label>
					<p>{l s='Use the links below to retreive your PayPal API credentials:' mod='paypalmxcustom'}<br />
					<a onclick="window.open(this.href, '1369346829804', 'width=415,height=530,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=0,left=0,top=0');
						return false;" href="https://www.paypal.com/us/cgibin/webscr?cmd=_get-api-signature&generic-flow=true" class="paypal_mx-module-btn">{l s='Live Mode API' mod='paypalmxcustom'}</a>&nbsp;&nbsp;&nbsp;//&nbsp;&nbsp;&nbsp;<a onclick="window.open(this.href, '1369346829804', 'width=415,height=530,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=0,left=0,top=0');
						return false;" href="https://www.sandbox.paypal.com/us/cgi-bin/webscr?cmd=_get-api-signature&generic-flow=true" class="paypal_mx-module-btn">{l s='Sandbox Mode API' mod='paypalmxcustom'}</a></p>
				</div>
			</div>

			<div class="form-group required">
				<label for="paypal_mx_account" class="col-sm-3 control-label">
						{l s='PayPal Business Account:' mod='paypalmxcustom'}
				</label>
				<div class="col-sm-4">
			...
			<div class="form-group required">
				<label for="paypal_mx_api_username" class="col-sm-3 control-label">
					{l s='PayPal API Username:' mod='paypalmxcustom'}
				</label>
				<div class="col-sm-4">
			...
			<div class="form-group required">
				<label for="paypal_mx_api_password" class="col-sm-3 control-label">
					{l s='PayPal API Password:' mod='paypalmxcustom'}
				</label>
				<div class="col-sm-4">
			...
			<div class="form-group required">
				<label for="paypal_mx_api_signature" class="col-sm-3 control-label">
					{l s='PayPal API Signature:' mod='paypalmxcustom'}
				</label>
				<div class="col-sm-4">
		...
		<fieldset>
			...
			<div class="form-group">
				...
				<label for="paypal_mx_checkbox_product" class="col-sm-3 control-label">
					{l s='Display button on' mod='paypalmxcustom'}
				</label>
				<div class="col-sm-4 PT2">
					...
					<label for="paypal_mx_checkbox_product" class="resetLabel">{l s='Product page' mod='paypalmxcustom'}</label> 
					...
					<label for="paypal_mx_checkbox_shopping_cart}" class="resetLabel">{l s='Shopping Cart' mod='paypalmxcustom'}</label>
				</div>
			</div>

			<div class="form-group">
				<label for="paypal_mx_checkbox_border_color" class="col-sm-3 control-label">
					{l s='Button border color' mod='paypalmxcustom'}
				</label>
				<div class="col-sm-4">
			...
			<div class="form-group">
				...
				<div class="col-sm-4 col-sm-offset-3">
					<span class="small"><sup class="warn">*</sup> {l s='Required fields' mod='paypalmxcustom'}</span>
				</div>
			</div>
			...
			<div class="form-group">
				<label class="col-sm-3 control-label"></label>
				<div class="col-sm-4 ">
					<input type="submit" name="SubmitBasicSettings" class="btn btn-primary" value="{l s='Save settings' mod='paypalmxcustom'}" />
				</div>
			</div>
		</fieldset>
	</form>
